...
<!-- Desktop main image  overflow-hidden-->
<div class="main-product-img d-none d-lg-block position-relative w-100  bg-light" style="aspect-ratio: 1/1;">
  @hookinsert('front.product.show.image.before')
  
    <div class="flex gap-6">
        <!-- Main Image -->
          <div class="zoom-box">
            <img src="{{ $product->image_url }}" class="object-cover border img-fluid main-image w-100 h-100" style="object-fit: cover;"/>
          </div>
    </div>

...
Route::middleware(['admin_auth:admin'])
    ->group(function () {
        ...
        Route::put('/products/{product}/is_today_deal', [Controllers\ProductController::class, 'isTodayDeal'])->name('products.is_today_deal');
        Route::put('/products/{product}/is_hot_deal', [Controllers\ProductController::class, 'isHotDeal'])->name('products.is_hot_deal');
        Route::put('/products/{product}/is_featured', [Controllers\ProductController::class, 'isFeatured'])->name('products.is_featured');

        Route::get('/products/{product}/copy', [Controllers\ProductController::class, 'copy'])->name('products.copy');
        Route::get('/products/{product}/barcode', [Controllers\ProductController::class, 'generateBarcode'])->name('products.barcode');

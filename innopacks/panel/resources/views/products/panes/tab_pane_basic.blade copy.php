        ...
        <div id="single_price_box1" class="">
          <div class="row">
               ...
               <div class="col-12 col-md-3">
                ...
                <div class="col-12 col-md-3">
                  <x-common-form-input :title="__('panel/product.plot_area')" name="propertyProps[plot_area]"
                                    value="{{ old('propertyProps.plot_area', $product->propertyProps->plot_area ?? '') }}" />
                </div>
                <div class="col-12 col-md-1">
                  <x-common-form-select :title="__('panel/product.select')" name="propertyProps[plot_area_type]"
                                  :value="old('propertyProps.plot_area_type', $product->propertyProps->plot_area_type ?? 0)" :options="$areaTypeOptions"
                                  key="id" label="name"/>  
                </div>
                <div class="col-12 col-md-3">
                  <x-common-form-input :title="__('panel/product.covered_area')" name="propertyProps[covered_area]"
                                    value="{{ old('propertyProps.covered_area', $product->propertyProps->covered_area ?? '') }}" />
                </div>
                <div class="col-12 col-md-1">
                  <x-common-form-select :title="__('panel/product.select')" name="propertyProps[covered_area_type]"
                                  :value="old('propertyProps.covered_area_type', $product->propertyProps->covered_area_type ?? 0)" :options="$areaTypeOptions"
                                  key="id" label="name"/>
                </div>
                <div class="col-12 col-md-3">
                  <x-common-form-input :title="__('panel/product.carpet_area')" name="propertyProps[carpet_area]"
                                    value="{{ old('propertyProps.carpet_area', $product->propertyProps->carpet_area ?? '') }}" />
                </div>

                <div class="col-12 col-md-1">
                  <x-common-form-select :title="__('panel/product.select')" name="propertyProps[carpet_area_type]"
                                  :value="old('propertyProps.carpet_area_type', $product->propertyProps->carpet_area_type ?? 0)" :options="$areaTypeOptions"
                                  key="id" label="name"/>  
                </div>



                <div class="plot-area-field">
                    ...
                    <div class="plot-area-input">
                      ...
                      <select class="plot-area-type" name="propertyProps[super_builtup_area_type]">
                          @foreach($areaTypeOptions as $value => $label)
                              <option
                                  value="{{ $label['id'] }}"
                                  {{ old('propertyProps.super_builtup_area_type', $product->propertyProps->super_builtup_area_type ?? '') == $value ? 'selected' : '' }}>
                                  {{ $label['name'] }}
                              </option>
                          @endforeach
                      </select>
                ...
                <!-- <div class="col-12 col-md-3 plot-area-field">
                  <x-common-form-input :title="__('panel/product.super_builtup_area')" name="propertyProps[super_builtup_area]"
                                    value="{{ old('propertyProps.super_builtup_area', $product->propertyProps->super_builtup_area ?? '') }}" />
                </div>
                <div class="col-12 col-md-1">
                  <x-common-form-select :title="__('panel/product.select')" name="propertyProps[super_builtup_area_type]"
                                  :value="old('propertyProps.super_builtup_area_type', $product->propertyProps->super_builtup_area_type ?? 0)" :options="$areaTypeOptions"
                                  key="id" label="name"/>  
                </div> -->
                ...
                <div class="col-12 col-md-3">
                  <x-common-form-input :title="__('panel/product.price')" name="propertyProps[price]"
                                    value="{{ old('propertyProps.price', $product->propertyProps->price ?? '') }}" />
                </div>

                <div class="col-12 col-md-1">
                  <x-common-form-select :title="__('panel/product.select')" name="propertyProps[price_type]"
                                  :value="old('propertyProps.price_type', $product->propertyProps->price_type ?? 0)" :options="$priceTypeOptions"
                                  key="id" label="name"/>
                </div> 
                ...
                <input type="hidden" name="skus[0][code]" value="0">

<!-- Rich Text Editor Module Template -->
<template id="module-editor-rich-text-template">
  <div class="rich-text-editor editor-container">
    ...
    <div class="editor-section">
      ...
      <div class="section-content">
        <div class="setting-group">
          <div class="setting-label">Rich Text Content</div>
            ...
            <div class="editor-preview">
              <div class="preview-header">
                ...
                <div class="preview-actions">
                  <button class="edit-btn" @click="openFloatingEditor" title="Edit Content">
                    <i class="el-icon-edit"></i>
              ...
              <div class="preview-content">
                ...
                <div v-else class="content-placeholder">
                  ...
                  <div class="placeholder-text">
                    <h4>No Content</h4>
                    <p>Click "Edit Content" to start writing rich text</p>
                  </div>
                </div>
              </div>
...
<!-- Rich Text Editor Module Script -->
    ...
    methods: {
      ...
      openFloatingEditor() {
          ...
          <div class="floating-editor-modal-content">
            <div class="floating-editor-header">
              <div class="d-flex align-items-center">
                <span class="me-3">Rich text editor</span>
            ...
            editor.ui.registry.addButton("toolbarImageButton", {
              ...
              onAction: () => {
                if (window.inno && window.inno.fileManagerIframe) {
                  ...
                  layer.msg('File manager not loaded, please refresh the page and try again', { icon: 2 });
                }
              },
            });
        ...
        if (typeof tinymce === "undefined") {
          layer.msg('Editor failed to load, please refresh the page and try again', { icon: 2 });
          return;
        }
        ...
        saveBtn.onclick = function() {
          if (self.floatingEditor) {
            ...
            saveBtn.innerHTML = '<i class="el-icon-check"></i><span>saved</span>';
            
            setTimeout(() => {
              saveBtn.classList.remove('saved');
              saveBtn.innerHTML = '<i class="el-icon-check"></i><span>Save Content</span>';
            }, 1200);
          }
        };

  ...
  <div class="editor-container">
    ...
    <div class="editor-section">
      ...
      <div class="section-content">
        ...
        <div class="setting-group">
          <div class="setting-label">Number of Items per Row</div>
          <div class="segmented-buttons">
            <div 
    ...
    <div class="editor-section">
      ...
      <div class="section-content">
        {{-- 商品搜索 --}}
        <div class="setting-group">
          <div class="setting-label">Search Products</div>
          <div class="autocomplete-group-wrapper">
            <el-autocomplete 
              ...
              placeholder="Please enter a keyword to search for products" 
          ...
          <div class="setting-tip">
            ...
            Search and add the products you want to display
          </div>
        </div>

        {{-- 已选商品列表 --}}
        <div class="setting-group">
          <div class="setting-label">Selected products</div>
          <div class="products-list" v-loading="loading">
            ...
            <div v-else class="empty-state">
              <i class="el-icon-shopping-cart-2"></i>
              <p>No products selected, please search and add products above</p>
            </div>
          </div>
        </div>
      </div>

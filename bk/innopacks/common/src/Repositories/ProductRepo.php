...
class ProductRepo extends BaseRepo
{
    ...
    public function handleProductData($data): array
    {
        ...
        return [
            ...
            'is_today_deal' => (bool) ($data['is_today_deal'] ?? false),
            'is_hot_deal'   => (bool) ($data['is_hot_deal'] ?? false),
    ...
    public function getTodayDealProducts($limit = 4): Collection
    {
        return Product::query()
            ->where('is_today_deal', true)
            // ->where('id', '!=', $product->id)
    ...
    public function getFeaturedProducts(): Collection
    {
     ...
     public function getHotDealProducts(): Collection
     {
     ...
     public function getPopularProducts(int $limit = 8): mixed
    {
        return $this->withActive()->builder()
            ->orderByDesc('viewed')
             ->with(['translation', 'masterSku',"reviews"])
